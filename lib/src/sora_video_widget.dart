...
///
/// [textureId] は null 許容で、null または負値のときは [placeholder] を
/// 表示する。0 は有効な texture id として Texture ウィジェットへ渡す。
///
/// ```dart
...
class SoraLocalVideoWidget extends StatelessWidget {
  ...
  ///
  /// null または負値のときは [placeholder] を表示する。0 は有効な値
  /// として Texture へそのまま渡す。
  final int? textureId;
  ...
  /// [textureId] が null または負値のときに表示する代替 Widget
  final Widget placeholder;
