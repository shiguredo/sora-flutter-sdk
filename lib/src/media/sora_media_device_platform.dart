...
/// ローカル映像キャプチャの MethodChannel 引数を組み立てます。
///
/// platform 実装との境界を純粋関数として検証できるように分離しています。
@internal
Map<String, Object?> buildLocalVideoCaptureArguments({
  required int videoSourcePtr,
  required String captureType,
  required int? clientId,
  String? videoDeviceId,
...
/// iOS のローカル映像キャプチャを開始します。
@internal
Future<void> startLocalVideoCapture({
  required int videoSourcePtr,
  required String captureType,
  required int? clientId,
  String? videoDeviceId,
  ...
  await soraMethodChannel.invokeMethod<void>(
    ...
    buildLocalVideoCaptureArguments(
      videoSourcePtr: videoSourcePtr,
      captureType: captureType,
      clientId: clientId,
      videoDeviceId: videoDeviceId,
...
/// iOS のローカル映像キャプチャを停止します。
@internal
Future<void> stopLocalVideoCapture({
  required int videoSourcePtr,
  required String captureType,
  required int? clientId,
  bool force = false,
