...
void main() {
  ...
  group('DevToolsConnectRequest', () {
    test('External Video Track の選択状態を保持する', () {
      final request = _createConnectRequest(
        dataChannelSignaling: false,
        ignoreDisconnectWebSocket: false,
        dataChannels: const <Map<String, Object?>>[],
        useExternalVideoTrack: true,
      );

      expect(request.useExternalVideoTrack, isTrue);
    });
  });
}
...
DevToolsConnectRequest _createConnectRequest({
  ...
  bool useExternalVideoTrack = false,
  String? clientId,
  String? bundleId,
  Object? metadata,
  ...
  return DevToolsConnectRequest(
    ...
    useExternalVideoTrack: useExternalVideoTrack,
