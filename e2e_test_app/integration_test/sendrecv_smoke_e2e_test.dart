// sendrecv で Sora に接続し、メディア設定未指定のままダミー映像を送信、
// 明示切断までを検証する smoke E2E。
...
void main() {
  ...
  testWidgets('sendrecv: メディア未指定でダミー映像を送信し明示切断までを検証する', (
    WidgetTester tester,
  ) async {
    ...
    // audio / video を未指定にし、Sora のデフォルトを適用した sendrecv で
    // 実際のローカル映像 Stream を接続して送信できることを確認する。
